(function () {
    ...
    Backendless.serverURL = 'https://api.gmo-mbaas.com';
    ...
    Backendless._ajax_for_nodejs = function (config) {
        ...
        if (!config.isAsync) {
            ...
            var req = httpx.request(options, function (res) {
                ...
                res.on('end', function(){
                    try {
                        config.asyncHandler.success(JSON.parse(buffer));
                    } catch(e){
    ...
    var deepExtend = function (destination, source) {
        for (var property in source) {
            if (source[property] !== undefined && source.hasOwnProperty(property)) {
                ...
                if(destination[property] && destination[property].hasOwnProperty(property) && destination[property][property].hasOwnProperty("__originSubID")){
