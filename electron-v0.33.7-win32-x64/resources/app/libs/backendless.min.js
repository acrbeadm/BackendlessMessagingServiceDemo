...
b.status?d.success(JSON.parse(b.responseText)):d.fault(JSON.parse(b.responseText)))});b.sendAsBinary(a);if(d)return b;if(200<=b.status&&300>b.status)return b.responseText?JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function U(a){var b=new XMLHttpRequest,c="-backendless-multipart-form-boundary-"+(new Date).getTime();K(this.fileName,a.target.result,c);b.open("PUT",this.uploadPath,!0);
...
JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function L(){this.restUrl=e.appPath+"/files/permissions"}function M(){this.restUrl=e.appPath+"/files"}function x(){this.restUrl=e.appPath+"/commerce/googleplay"}function E(){this.restUrl=e.appPath+"/servercode/events"}NodeDevice={name:"NODEJS",platform:"NODEJS",uuid:"someId",version:"1"};h()||(encodeURIComponent=function(a){return escape(a)});
var e=this.Backendless||{},u=function(){};this.Backendless=e;Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c;if(null==this)throw new TypeError('"this" is null or not defined');var d=Object(this),f=d.length>>>0;if(0===f)return-1;c=+b||0;Infinity===Math.abs(c)&&(c=0);if(c>=f)return-1;for(c=Math.max(0<=c?c:f-Math.abs(c),0);c<f;){if(c in d&&d[c]===a)return c;c++}return-1});var V=Object.prototype.hasOwnProperty,N=Array.prototype.forEach,W=Array.isArray,I=null;e.VERSION="0.2";e.serverURL=
"https://api.gmo-mbaas.com";(function(){try{"undefined"==typeof XMLHttpRequest.prototype.sendAsBinary&&(XMLHttpRequest.prototype.sendAsBinary=function(a){for(var c=new ArrayBuffer(a.length),c=new Uint8Array(c,0),d=0;d<a.length;d++)c[d]=a.charCodeAt(d)&255;this.send(c)})}catch(a){}})();var X=function(){var a=h()?navigator.userAgent.toLowerCase():"NodeJS",b=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&
/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[],a=b[1]||"",b=b[2]||"0",c={};a&&(c[a]=!0,c.version=b);return c}(),v=null;e.browser=X;var g=e.Utils={isObject:function(a){return a===Object(a)},isString:function(a){return"String"===Object.prototype.toString.call(a).slice(8,-1)},isNumber:function(a){return"Number"===Object.prototype.toString.call(a).slice(8,-1)},isFunction:function(a){return"Function"===Object.prototype.toString.call(a).slice(8,-1)},isBoolean:function(a){return"Boolean"===Object.prototype.toString.call(a).slice(8,
-1)},isDate:function(a){return"Date"===Object.prototype.toString.call(a).slice(8,-1)}};g.isArray=W||function(a){return"Array"===Object.prototype.toString.call(a).slice(8,-1)};g.addEvent=function(a,b,c){b.addEventListener?b.addEventListener(a,c,!1):b.attachEvent?b.attachEvent("on"+a,c):b[a]=c};g.isEmpty=function(a){if(null==a)return!0;if(g.isArray(a)||g.isString(a))return 0===a.length;for(var b in a)if(a.hasOwnProperty(b)&&void 0!==a[b]&&null!==a[b])return!1;return!0};g.removeEvent=function(a,b){b.removeEventListener?
b.removeEventListener(a,null,!1):b.detachEvent?b.detachEvent("on"+a,null):b[a]=null};g.forEach=function(a,b,c){if(a)if(N&&a.forEach===N)a.forEach(b,c);else if(a.length===+a.length)for(var d=0,f=a.length;d<f&&!(d in a&&b.call(c,a[d],d,a)===breaker);d++);else for(d in a)if(V.call(a,d)&&b.call(c,a[d],d,a)===breaker)break};e.setUIState=function(a){if(void 0===a)throw Error("UI state name must be defined or explicitly set to null");v=null===a?null:a};e._ajax_for_browser=function(a){var b=["cacheOnly",
"remoteDataOnly","fromCacheOrRemote","fromRemoteOrCache","fromCacheAndRemote"],c={ignoreCache:function(a){return d(a)},cacheOnly:function(a){var b=e.LocalCache.get(a.url.replace(/([^A-Za-z0-9])/g,"")),c={message:"error: cannot find data in Backendless.LocalCache",statusCode:404};if(b)return a.isAsync&&a.asyncHandler.success(b),b;if(a.isAsync)a.asyncHandler.fault(c);else throw c;},remoteDataOnly:function(a){return d(a)},fromCacheOrRemote:function(a){var b=e.LocalCache.get(a.url.replace(/([^A-Za-z0-9])/g,
...
e.LocalCache.getCachePolicy(a.urlBlueprint),"___class"in b&&delete b.___class,e.LocalCache.set(a.urlBlueprint,b))},n=function(){return a.cacheActive&&"fromRemoteOrCache"==a.cachePolicy.policy&&e.LocalCache.exists(a.urlBlueprint)};b.open(a.method,a.url,a.isAsync);b.setRequestHeader("Content-Type",c);b.setRequestHeader("application-id",e.applicationId);b.setRequestHeader("secret-key",e.secretKey);b.setRequestHeader("application-type","JS");null!=p&&p["user-token"]?b.setRequestHeader("user-token",p["user-token"]):
e.LocalCache.exists("user-token")&&b.setRequestHeader("user-token",e.LocalCache.get("user-token"));null!==v&&b.setRequestHeader("uiState",v);a.isAsync&&(b.onreadystatechange=function(){4==b.readyState&&(200<=b.status&&300>b.status?(d=f(b),h(d),a.asyncHandler.success&&a.asyncHandler.success(d)):n()?a.asyncHandler.success&&a.asyncHandler.success(e.LocalCache.get(a.urlBlueprint)):a.asyncHandler.fault&&a.asyncHandler.fault(l(b)))});b.send(a.data);if(a.isAsync)return b;if(200<=b.status&&300>b.status)return d=
f(b),h(d),d;if(n())return e.LocalCache.get(a.urlBlueprint);throw l(b);};a.method=a.method||"GET";a.cachePolicy=a.cachePolicy||{policy:"ignoreCache"};a.isAsync="boolean"==typeof a.isAsync?a.isAsync:!1;a.cacheActive="GET"==a.method&&-1!=b.indexOf(a.cachePolicy.policy);a.urlBlueprint=a.url.replace(/([^A-Za-z0-9])/g,"");try{return c[a.cachePolicy.policy].call(this,a)}catch(f){throw console.log("error: "+f.message),f;}};e._ajax_for_nodejs=function(a){a.data=a.data||"";"string"!==typeof a.data&&(a.data=
JSON.stringify(a.data));a.asyncHandler=a.asyncHandler||{};a.isAsync="boolean"==typeof a.isAsync?a.isAsync:!1;var b=a.url.substr(0,a.url.indexOf("/",8)).substr(0,a.url.indexOf(":")),c=a.url.substr(0,a.url.indexOf("/",8)).substr(a.url.indexOf("/")+2),d=c.substr(0,-1==c.indexOf(":")?c.length:c.indexOf(":")),c=-1!=c.indexOf(":")?parseInt(c.substr(c.indexOf(":")+1)):"http"==b?80:443,d={host:d,port:c,method:a.method||"GET",path:a.url.substr(a.url.indexOf("/",8)),headers:{"Content-Length":a.data?a.data.length:
0,"Content-Type":a.data?"application/json":"application/x-www-form-urlencoded","application-id":e.applicationId,"secret-key":e.secretKey,"application-type":"JS"}},f="";null!=p&&(d.headers["user-token"]=p["user-token"]);if(a.isAsync)b=require(b).request(d,function(b){b.setEncoding("utf8");b.on("data",function(a){f+=a});b.on("end",function(){try{a.asyncHandler.success(JSON.parse(f))}catch(b){a.asyncHandler.success(f)}})});else throw Error("Use Async type of request using Backendless with NodeJS. Add Backendless.Async(successCallback, errorCallback) as last argument");
b.on("error",function(b){a.asyncHandler.fault||(a.asyncHandler.fault=function(){});a.asyncHandler.fault(b)});b.write(a.data,"utf8");return b.end()};e._ajax=h()?e._ajax_for_browser:e._ajax_for_nodejs;var w=function(){var a=(g.isFunction(this)?this.toString():this.constructor.toString()).match(/function\s+(\w+)/);return a&&1<a.length?a[1]:""},y=function(a){var b=[],c,d;c=0;for(d=a.length;c<d;++c)b.push(encodeURIComponent(a[c]));return b.join(",")},O=function(a){var b=function(a){var b=null,c=null,e;
for(e in a)if(a.hasOwnProperty(e)&&"___class"===e){b=a[e];break}if(b)try{c=eval(b),a=q(new c,a)}catch(g){}return a};if(g.isObject(a)&&null!=a)if(g.isArray(a))for(var c=a.length;c--;)a[c]=b(a[c]);else a=b(a);return a},q=function(a,b){for(var c in b)void 0!==b[c]&&b.hasOwnProperty(c)&&(a[c]=a[c]||{},a[c]=O(b[c]),a[c]&&(a[c].hasOwnProperty(c)&&a[c][c].hasOwnProperty("__originSubID"))&&(a[c][c]=O(a[c])));return a},l=function(a){var b,c;b=0;for(c=a.length;b<c;++b)if(a[b]instanceof n)return a[b];return null};
e.LocalCache=function(){var a={},b;a.enabled=!1;a.exists=function(a){};a.set=function(a,b){};a.get=function(a){};a.remove=function(a){};a.clear=function(){};a.flushExpired=function(){};a.getCachePolicy=function(a){};a.getAll=function(){};a.serialize=function(a){return JSON.stringify(a)};a.deserialize=function(a){if("string"==typeof a)try{return JSON.parse(a)}catch(b){return a||void 0}};if(function(){try{return h()&&"localStorage"in window&&window.localStorage?(localStorage.setItem("localStorageTest",
!0),localStorage.removeItem("localStorageTest"),!0):!1}catch(a){return!1}}()){b=window.localStorage;var c=function(){"Backendless"in b||b.setItem("Backendless",a.serialize({}))},d=function(a){var b=!1;"Object"==Object.prototype.toString.call(a).slice(8,-1)&&"cachePolicy"in a&&("timeToLive"in a.cachePolicy&&-1!=a.cachePolicy.timeToLive&&"created"in a.cachePolicy)&&(b=(new Date).getTime()-a.cachePolicy.created>a.cachePolicy.timeToLive);return b};c();a.enabled=!0;a.exists=function(b){return void 0!==
a.get(b)};a.set=function(d,e){if(void 0===e)return a.remove(d);c();var k=a.deserialize(b.getItem("Backendless"));"Object"==Object.prototype.toString.call(e).slice(8,-1)&&"cachePolicy"in e&&"timeToLive"in e.cachePolicy&&(e.cachePolicy.created=(new Date).getTime());k[d]=e;try{b.setItem("Backendless",a.serialize(k))}catch(g){k={},k[d]=e,b.setItem("Backendless",a.serialize(k))}return e};a.get=function(f){c();var e=a.deserialize(b.getItem("Backendless")),k=e[f],g=k;d(k)&&(delete e[f],b.setItem("Backendless",
a.serialize(e)),g=void 0);g&&g.cachePolicy&&delete g.cachePolicy;return g};a.remove=function(d){var e;c();d=d.replace(/([^A-Za-z0-9-])/g,"");var k=a.deserialize(b.getItem("Backendless"));k.hasOwnProperty(d)&&(e=delete k[d]);b.setItem("Backendless",a.serialize(k));return e};a.clear=function(){b.setItem("Backendless",a.serialize({}))};a.getAll=function(){c();var d=a.deserialize(b.getItem("Backendless")),e={},k;for(k in d)d.hasOwnProperty(k)&&(e[k]=d[k],null!==e[k]&&e[k].hasOwnProperty("cachePolicy")&&
delete e[k].cachePolicy);return e};a.flushExpired=function(){c();var f=a.deserialize(b.getItem("Backendless")),e,k;for(k in f)f.hasOwnProperty(k)&&(e=f[k],d(e)&&(delete f[k],b.setItem("Backendless",a.serialize(f))))};a.getCachePolicy=function(d){c();return(d=a.deserialize(b.getItem("Backendless"))[d])?d.cachePolicy:void 0}}return a}();e.LocalCache.enabled&&e.LocalCache.flushExpired();e.Async=n;t.prototype={addProperty:function(a){this.properties=this.properties||[];this.properties.push(a)}};e.DataQuery=
t;z.prototype={_extractQueryOptions:function(a){var b=[];if("undefined"!=typeof a.pageSize){if(1>a.pageSize||100<a.pageSize)throw Error("PageSize can not be less then 1 or greater than 100");b.push("pageSize="+encodeURIComponent(a.pageSize))}if(a.offset){if(0>a.offset)throw Error("Offset can not be less then 0");b.push("offset="+encodeURIComponent(a.offset))}a.sortBy&&(g.isString(a.sortBy)?b.push("sortBy="+encodeURIComponent(a.sortBy)):g.isArray(a.sortBy)&&b.push("sortBy="+y(a.sortBy)));a.relationsDepth&&
g.isNumber(a.relationsDepth)&&b.push("relationsDepth="+encodeURIComponent(Math.floor(a.relationsDepth)));a.relations&&g.isArray(a.relations)&&b.push("loadRelations="+(a.relations.length?y(a.relations):"*"));return b.join("&")},_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){var b=this.model;a=a.fields||a;b=new b;s(a,this);q(b,a);return this._formCircDeps(b)},_parseFindResponse:function(a){var b,c=this.model,
d;if(a.data){var f=a,e=f.data;a=0;for(b=e.length;a<b;++a)e[a]=e[a].fields||e[a],d=new c,q(d,e[a]),e[a]=d;s(f,this);return f}a=a.fields||a;d=new c;q(d,a);return this._formCircDeps(d)},_load:function(a,b){if(a){var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",url:a,isAsync:d,asyncHandler:c});return d?c:this._parseResponse(c)}},_replCircDeps:function(a){var b=[a],c,d=function(a){for(var e in a)if(a.hasOwnProperty(e)&&"object"==typeof a[e]&&null!=a[e])if(-1!=(c=b.indexOf(a[e]))){var k=
b[c],l;if(!(l=b[c].__subID))for(var h=l="";36>h++;l+=51*h?(h^15?8^Math.random()*(h^20?16:4):4).toString(16):"-");k.__subID=l;a[e]={__originSubID:b[c].__subID}}else g.isDate(a[e])?a[e]=a[e].getTime():(b.push(a[e]),d(a[e]))};d(a)},_formCircDeps:function(a){var b={},c=new a.constructor,d=function(a,c){a.hasOwnProperty("__subID")&&(b[a.__subID]=c,delete a.__subID);for(var e in a)a.hasOwnProperty(e)&&("object"==typeof a[e]&&null!=a[e]?a[e].hasOwnProperty("__originSubID")?c[e]=b[a[e].__originSubID]:(c[e]=
...
q(h,d)}return e._ajax({method:"POST",url:this.restUrl+"/"+a,isAsync:k,asyncHandler:g,data:JSON.stringify(h)})},sendEmail:function(a,b,c,d,f){var m=l(arguments),k=null!=m,h={};if(a&&!g.isEmpty(a)&&g.isString(a))h.subject=a;else throw"Subject is required parameter and must be a nonempty string";if(b instanceof Bodyparts&&!g.isEmpty(b))h.bodyparts=b;else throw"Use Bodyparts as bodyParts argument, must contain at least one property";if(c&&g.isArray(c)&&!g.isEmpty(c))h.to=c;else throw"Recipients is required parameter, must be a nonempty array";
if(d)if(g.isArray(d))g.isEmpty(d)||(h.attachment=d);else throw"Attachments must be an array of file IDs from File Service";return e._ajax({method:"POST",url:this.restUrl+"/email",isAsync:k,asyncHandler:m,data:JSON.stringify(h)})},cancel:function(a,b){return e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:null!=b,asyncHandler:new n(u)})},registerDevice:function(a,b,c){var d=l(arguments),f=null!=d,m=h()?window.device:NodeDevice,k={deviceToken:null,deviceId:m.uuid,os:m.platform,osVersion:m.version};
...
"*";return e._ajax({method:"PUT",url:this.restUrl+"/"+a+"/"+encodeURIComponent(b),data:JSON.stringify(k),isAsync:g,asyncHandler:f})}};M.prototype={saveFile:function(a,b,c,d,f){if(!a||!g.isString(a))throw Error('Missing value for the "path" argument. The argument must contain a string value');if(!b||!g.isString(a))throw Error('Missing value for the "fileName" argument. The argument must contain a string value');d instanceof e.Async&&(f=d,d=null);c instanceof File||(c=new Blob([c]));if(28E5<c.size)throw Error("File Content size must be less than 2,800,000 bytes");
a=this.restUrl+"/binary/"+a+(g.isString(b)?"/"+b:"")+(d?"?overwrite=true":"");try{var h=new FileReader;h.fileName=b;h.uploadPath=a;h.onloadend=U;f&&(h.asyncHandler=f);h.onerror=function(a){f.fault(a)};h.readAsDataURL(c);if(!f)return!0}catch(k){console.log(k)}},upload:function(a,b,c){a=a.files||a;b=this.restUrl+"/"+b+"/";if(h())if(window.File&&window.FileList){a instanceof File&&(a=[a]);for(var d=0,e=0,g=a.length;e<g;e++)try{var k=new FileReader;k.fileName=a[e].name;k.uploadPath=b+k.fileName;k.onloadend=
T;k.asyncHandler=c;k.onerror=function(a){c.fault(a)};k.readAsBinaryString(a[e])}catch(l){d++}}else d=document.createElement("iframe"),d.id=d.name="ifr"+(new Date).getTime(),d.width=d.height="0",document.body.appendChild(d),k=document.createElement("form"),k.target=d.name,k.enctype="multipart/form-data",k.method="POST",document.body.appendChild(k),k.appendChild(a),a=a.value,(d=a.lastIndexOf("\\"))&&(a=a.substring(d+1)),k.action=b+a,k.submit();else throw"Upload File not supported with NodeJS";},remove:function(a,
b){var c=l(arguments),d=null!=c,f=0==a.indexOf("http://")||0==a.indexOf("https://")?a:this.restUrl+"/"+a;e._ajax({method:"DELETE",url:f,isAsync:d,asyncHandler:c})},removeDirectory:function(a,b){var c=l(arguments);e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:null!=c,asyncHandler:c})}};x.prototype._wrapAsync=function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};x.prototype.validatePlayPurchase=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");
for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",url:this.restUrl+"/validate/"+a+"/inapp/"+b+"/purchases/"+c,isAsync:h,asyncHandler:f})};x.prototype.cancelPlaySubscription=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");
for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"POST",url:this.restUrl+"/"+a+"/subscription/"+b+"/purchases/"+c+"/cancel",isAsync:h,asyncHandler:f})};x.prototype.getPlaySubscriptionStatus=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");
for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",url:this.restUrl+"/"+a+"/subscription/"+b+"/purchases/"+c,isAsync:h,asyncHandler:f})};E.prototype._wrapAsync=function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};E.prototype.dispatch=function(a,b,c){if(!a||!g.isString(a))throw Error("Event Name must be provided and must be not an empty STRING!");
b=g.isObject(b)?b:{};var d=l(arguments),f=null!=d;d&&(d=this._wrapAsync(d));b=b instanceof e.Async?{}:b;return e._ajax({method:"POST",url:this.restUrl+"/"+a,data:JSON.stringify(b),isAsync:f,asyncHandler:d})};var Q=function(){},R=[];Q.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},put:function(a,b,c,d){if(!g.isString(a))throw Error("You can use only String as key to put into Cache");
if(c)if("object"==typeof c&&!d)d=c,c=null;else if("number"!=typeof c)throw Error("You can use only String as timeToLive attribute to put into Cache");d=l([b,d]);var f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));g.isObject(b)&&b.constructor!==Object&&(b.___class=b.___class||w.call(b));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+(c?"?timeout="+c:""),data:JSON.stringify(b),isAsync:f,asyncHandler:d})},expireIn:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=
g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+"/expireIn?timeout="+b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error('The "key" argument must be String. The "seconds" argument can be either Number or Date');},expireAt:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));
return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+"/expireAt?timestamp="+b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error("You can use only String as key while expire in Cache. Second attribute must be declared and must be a Number or Date type");},cacheMethod:function(a,b,c,d){if(!g.isString(b))throw Error('The "key" argument must be String');var f=l(arguments),h=!1;null!=f&&(h=!0,f=this._wrapAsync(f));return e._ajax({method:a,url:e.serverURL+"/"+e.appVersion+
"/cache/"+b+(c?"/check":""),isAsync:h,asyncHandler:f})},contains:function(a,b){return this.cacheMethod("GET",a,!0,b)},get:function(a,b){if(!g.isString(a))throw Error('The "key" argument must be String');var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",url:e.serverURL+"/"+e.appVersion+"/cache/"+a,isAsync:d,asyncHandler:c});if(g.isObject(c)&&c.___class){var f;try{f=new (eval(c.___class))(c)}catch(h){f=new R[c.___class](c)}return f}return c},remove:function(a,b){return this.cacheMethod("DELETE",
a,!1,b)},setObjectFactory:function(a,b){R[a]=b}};var r=function(){},S=function(a){this.name=a};r.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},of:function(a){return new S(a)},getConstructor:function(){return this},counterNameValidation:function(a,b){if(!a)throw Error('Missing value for the "counterName" argument. The argument must contain a string value.');if(!g.isString(a))throw Error('Invalid value for the "value" argument. The argument must contain only string values');
